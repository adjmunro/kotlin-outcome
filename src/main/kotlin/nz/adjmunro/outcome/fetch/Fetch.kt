 ...
 * @param recover The transformation to apply to any [non-fatal][nz.adjmunro.outcome.util.nonFatalOrThrow] [Throwable] that is caught.
 ...
 * [Outcome][nz.adjmunro.outcome.outcome.Outcome] for this purpose.*
 *
